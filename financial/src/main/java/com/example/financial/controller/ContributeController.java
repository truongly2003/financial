...
public class ContributeController {
    ...
    @GetMapping("/filter")
    public ResponseEntity<ApiResponse<List<GoalContributionResponse>>> getAllContributeByUserIdAndGoalId(@RequestParam Integer goalId, @RequestParam Integer userId) {
